...
Page(A.assignPage({
  ...
  onLoad: function(options) {
    ...
    if (options.goods_id) {
      ...
      A.updata.getBarginDetails(options.goods_id, 0,recommend_id).then(res => {
  ...
  getPhoneNumber: function (e) {
    ...
    A.updata.getPhoneNum(encryptedData, iv).then(res => {
      if (res.status == 1) {
        ...
        A.G("navigateTo:///pages/goodsInfo/goodsBargain/bargainDetail/bargainDetail?goods_id=" + this.data.goods_info.goods_id + "&bargain_id=-1")
      }else{
  ...
  onShareAppMessage: function() {
    ...
    if (goods_info.goods_name) {
      ...
      let url = '/pages/goodsInfo/goodsBargain/goodsBargain?store_id=' + store_id + "&goods_id=" + goods_id + "&group_id=" + group_id + "&m=" + user_id;
    console.log(url)
  ...
  goBargain:function(){
    // A.G("'navigateTo:///pages/goodsInfo/goodsBargain/bargainDetail/bargainDetail?goods_id=" + this.data.goods_info.goods_id + "&bargain_id=-1" + "&recommend_id=" + this.data.recommend_id)
      ...
      wx.navigateTo({
          url: '/pages/goodsInfo/goodsBargain/bargainDetail/bargainDetail?goods_id=' + this.data.goods_info.goods_id + '&bargain_id=-1' + '&recommend_id=' + this.data.recommend_id + '&recData=' + rec,
      })
  }
